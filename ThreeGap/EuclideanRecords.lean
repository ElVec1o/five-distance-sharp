...
Assembles the Euclidean route: with the **Euclidean defect cost** `r q = deltaN(euclNorm 2) α q`, the
...
(`chevallier_gap_count_le`) gives the Euclidean five-distance bound **`g₂ ≤ 6`**: at most six distinct
...
import ThreeGap.EuclideanDefect
