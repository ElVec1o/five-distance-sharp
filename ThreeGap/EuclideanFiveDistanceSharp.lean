...
import ThreeGap.EuclideanNN
import ThreeGap.EuclideanGrowthFour

/-!
# The sharp Euclidean five-distance theorem `g₂ ≤ 5`

The capstone of the Haynes–Marklof route: the number of distinct Euclidean nearest-neighbour distances
...
/-- **The sharp Euclidean five-distance theorem `g₂ ≤ 5`.** For any `α : Fin 2 → ℝ` with an irrational
