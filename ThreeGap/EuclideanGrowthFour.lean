...
-/
import ThreeGap.FiveDistanceHM
...
*do* fit), so the extra structure of Haynes–Marklof Theorem 8 (`FiveDistance.hm_theorem8`) is used: the
...
best-`L²`-approximation sequence `(q, p)` of `α : Fin 2 → ℝ` with the record/monotonicity hypotheses,
