...
-/
import ThreeGap.EuclideanFiveDistanceSharp
...
So sharpness ⟺ **four record denominators in the doubling window `(⌈N/2⌉, N]`** — the extremal case of
...
theorem dstar7 : deltaN (euclNorm 2) astar 7 = Real.sqrt 68 / 29 := by
  rw [deltaN_astar 7 1 2 (-8) (-2) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
...
theorem card_ge_five (α : Fin 2 → ℝ)
  ...
  · rw [v4, v5]
    refine inf_lt_inf (fun n => deltaN (euclNorm 2) α (n : ℤ)) 7 (by decide) ne6 ne7 (fun n hn => ?_)
    show deltaN (euclNorm 2) α (7 : ℤ) < deltaN (euclNorm 2) α (n : ℤ); exact H1 n hn
  · rw [v3, v4]
    refine inf_lt_inf (fun n => deltaN (euclNorm 2) α (n : ℤ)) 8 (by decide) ne7 ne8 (fun n hn => ?_)
    show deltaN (euclNorm 2) α (8 : ℤ) < deltaN (euclNorm 2) α (n : ℤ); exact H2 n hn
  · rw [v1, v3]
    refine inf_lt_inf (fun n => deltaN (euclNorm 2) α (n : ℤ)) 10 (by decide) ne8 ne10 (fun n hn => ?_)
    show deltaN (euclNorm 2) α (10 : ℤ) < deltaN (euclNorm 2) α (n : ℤ); exact H3 n hn
  · rw [v0, v1]
    refine inf_lt_inf (fun n => deltaN (euclNorm 2) α (n : ℤ)) 11 (by decide) ne10 ne11 (fun n hn => ?_)
    show deltaN (euclNorm 2) α (11 : ℤ) < deltaN (euclNorm 2) α (n : ℤ); exact H4 n hn
...
/-- **`deltaN · d` is `|d|`-Lipschitz in `α`.** (Both are distances to the lattice; perturbing `α` by
...
theorem H1_aprt (s : ℝ) (hs0 : 0 ≤ s) (hsmall : 1276 * s * Real.sqrt 317 < 1) :
  ...
  interval_cases n
  · exact Hpair s hs0 hsmall 7 1 68 73 dstar7 dstar1 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 7 2 68 205 dstar7 dstar2 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 7 3 68 106 dstar7 dstar3 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 7 4 68 153 dstar7 dstar4 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 7 5 68 317 dstar7 dstar5 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 7 6 68 221 dstar7 dstar6 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
...
theorem H2_aprt (s : ℝ) (hs0 : 0 ≤ s) (hsmall : 1276 * s * Real.sqrt 317 < 1) :
  ...
  intro n hn; obtain ⟨hn1, hn2⟩ := Finset.mem_Icc.mp hn
  interval_cases n
  · exact Hpair s hs0 hsmall 8 1 61 73 dstar8 dstar1 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 2 61 205 dstar8 dstar2 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 3 61 106 dstar8 dstar3 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 4 61 153 dstar8 dstar4 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 5 61 317 dstar8 dstar5 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 6 61 221 dstar8 dstar6 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 8 7 61 68 dstar8 dstar7 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
...
theorem H3_aprt (s : ℝ) (hs0 : 0 ≤ s) (hsmall : 1276 * s * Real.sqrt 317 < 1) :
  ...
  intro n hn; obtain ⟨hn1, hn2⟩ := Finset.mem_Icc.mp hn
  interval_cases n
  · exact Hpair s hs0 hsmall 10 1 50 73 dstar10 dstar1 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 2 50 205 dstar10 dstar2 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 3 50 106 dstar10 dstar3 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 4 50 153 dstar10 dstar4 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 5 50 317 dstar10 dstar5 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 6 50 221 dstar10 dstar6 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 7 50 68 dstar10 dstar7 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 10 8 50 61 dstar10 dstar8 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
...
theorem H4_aprt (s : ℝ) (hs0 : 0 ≤ s) (hsmall : 1276 * s * Real.sqrt 317 < 1) :
  ...
  intro n hn; obtain ⟨hn1, hn2⟩ := Finset.mem_Icc.mp hn
  interval_cases n
  · exact Hpair s hs0 hsmall 11 1 17 73 dstar11 dstar1 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 2 17 205 dstar11 dstar2 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 3 17 106 dstar11 dstar3 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 4 17 153 dstar11 dstar4 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 5 17 317 dstar11 dstar5 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 6 17 221 dstar11 dstar6 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 7 17 68 dstar11 dstar7 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 8 17 61 dstar11 dstar8 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 9 17 200 dstar11 dstar9 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
  · exact Hpair s hs0 hsmall 11 10 17 50 dstar11 dstar10 (by norm_num) (by norm_num) (by norm_num) (by norm_num)
...
five** distinct Euclidean nearest-neighbour distances — so the bound `nnDistE_count_le_five` is sharp.
