...
-/
import ThreeGap.SimultaneousDirichlet
import ThreeGap.LinftyFiveDistanceSharpArith

/-!
# The `L∞` three-torus bound `g_∞ ≤ 2^d+1` is **sharp** for `d = 3`: nine distances attained

The repo's `SimDirichlet.nnDist_count_unconditional` proves the sup-norm bound `g_∞ ≤ 2^d + 1` in all
...
Same dynamics-free, integer-exact route as `LinftyRecords.sharp_attained` (`d = 2`), extended to three
  ...
  · refine le_ciInf (fun p => ?_)
    ...
    · refine le_trans ?_ (norm_le_pi_norm (rem astar d p) 0)
      ...
      have hnum : ((|r₀| : ℤ) : ℝ) ≤ ((|-785 * d - 50000 * p 0| : ℤ) : ℝ) := by
        exact_mod_cast abs_residue_le 50000 r₀ (-785 * d) (by norm_num) hb0 ⟨n₀, by linarith [hr0]⟩ (p 0)
      linarith
    · refine le_trans ?_ (norm_le_pi_norm (rem astar d p) 1)
      rw [c1 p, normcoord, hMa]
      have hnum : ((|r₁| : ℤ) : ℝ) ≤ ((|-11872 * d - 50000 * p 1| : ℤ) : ℝ) := by
        exact_mod_cast abs_residue_le 50000 r₁ (-11872 * d) (by norm_num) hb1 ⟨n₁, by linarith [hr1]⟩ (p 1)
      linarith
    · refine le_trans ?_ (norm_le_pi_norm (rem astar d p) 2)
      rw [c2 p, normcoord, hMa]
      have hnum : ((|r₂| : ℤ) : ℝ) ≤ ((|-2875 * d - 50000 * p 2| : ℤ) : ℝ) := by
        exact_mod_cast abs_residue_le 50000 r₂ (-2875 * d) (by norm_num) hb2 ⟨n₂, by linarith [hr2]⟩ (p 2)
      linarith

/-- The witness defects `delta α* m = M_m/50000` for `m = 1,…,72`. -/
theorem dstar1 : delta astar 1 = (11872 : ℝ) / 50000 := by
  rw [delta_astar 1 0 0 0 (-785) (-11872) (-2875) 11872 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar2 : delta astar 2 = (23744 : ℝ) / 50000 := by
  rw [delta_astar 2 0 0 0 (-1570) (-23744) (-5750) 23744 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar3 : delta astar 3 = (14384 : ℝ) / 50000 := by
  rw [delta_astar 3 0 (-1) 0 (-2355) 14384 (-8625) 14384 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar4 : delta astar 4 = (11500 : ℝ) / 50000 := by
  rw [delta_astar 4 0 (-1) 0 (-3140) 2512 (-11500) 11500 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar5 : delta astar 5 = (14375 : ℝ) / 50000 := by
  rw [delta_astar 5 0 (-1) 0 (-3925) (-9360) (-14375) 14375 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar6 : delta astar 6 = (21232 : ℝ) / 50000 := by
  rw [delta_astar 6 0 (-1) 0 (-4710) (-21232) (-17250) 21232 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar7 : delta astar 7 = (20125 : ℝ) / 50000 := by
  rw [delta_astar 7 0 (-2) 0 (-5495) 16896 (-20125) 20125 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar8 : delta astar 8 = (23000 : ℝ) / 50000 := by
  rw [delta_astar 8 0 (-2) 0 (-6280) 5024 (-23000) 23000 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar9 : delta astar 9 = (24125 : ℝ) / 50000 := by
  rw [delta_astar 9 0 (-2) (-1) (-7065) (-6848) 24125 24125 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar10 : delta astar 10 = (21250 : ℝ) / 50000 := by
  rw [delta_astar 10 0 (-2) (-1) (-7850) (-18720) 21250 21250 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar11 : delta astar 11 = (19408 : ℝ) / 50000 := by
  rw [delta_astar 11 0 (-3) (-1) (-8635) 19408 18375 19408 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar12 : delta astar 12 = (15500 : ℝ) / 50000 := by
  rw [delta_astar 12 0 (-3) (-1) (-9420) 7536 15500 15500 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar13 : delta astar 13 = (12625 : ℝ) / 50000 := by
  rw [delta_astar 13 0 (-3) (-1) (-10205) (-4336) 12625 12625 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar14 : delta astar 14 = (16208 : ℝ) / 50000 := by
  rw [delta_astar 14 0 (-3) (-1) (-10990) (-16208) 9750 16208 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar15 : delta astar 15 = (21920 : ℝ) / 50000 := by
  rw [delta_astar 15 0 (-4) (-1) (-11775) 21920 6875 21920 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar16 : delta astar 16 = (12560 : ℝ) / 50000 := by
  rw [delta_astar 16 0 (-4) (-1) (-12560) 10048 4000 12560 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar17 : delta astar 17 = (13345 : ℝ) / 50000 := by
  rw [delta_astar 17 0 (-4) (-1) (-13345) (-1824) 1125 13345 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar18 : delta astar 18 = (14130 : ℝ) / 50000 := by
  rw [delta_astar 18 0 (-4) (-1) (-14130) (-13696) (-1750) 14130 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar19 : delta astar 19 = (24432 : ℝ) / 50000 := by
  rw [delta_astar 19 0 (-5) (-1) (-14915) 24432 (-4625) 24432 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar20 : delta astar 20 = (15700 : ℝ) / 50000 := by
  rw [delta_astar 20 0 (-5) (-1) (-15700) 12560 (-7500) 15700 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar21 : delta astar 21 = (16485 : ℝ) / 50000 := by
  rw [delta_astar 21 0 (-5) (-1) (-16485) 688 (-10375) 16485 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar22 : delta astar 22 = (17270 : ℝ) / 50000 := by
  rw [delta_astar 22 0 (-5) (-1) (-17270) (-11184) (-13250) 17270 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar23 : delta astar 23 = (23056 : ℝ) / 50000 := by
  rw [delta_astar 23 0 (-5) (-1) (-18055) (-23056) (-16125) 23056 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar24 : delta astar 24 = (19000 : ℝ) / 50000 := by
  rw [delta_astar 24 0 (-6) (-1) (-18840) 15072 (-19000) 19000 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar25 : delta astar 25 = (21875 : ℝ) / 50000 := by
  rw [delta_astar 25 0 (-6) (-1) (-19625) 3200 (-21875) 21875 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar26 : delta astar 26 = (24750 : ℝ) / 50000 := by
  rw [delta_astar 26 0 (-6) (-1) (-20410) (-8672) (-24750) 24750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar27 : delta astar 27 = (22375 : ℝ) / 50000 := by
  rw [delta_astar 27 0 (-6) (-2) (-21195) (-20544) 22375 22375 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar28 : delta astar 28 = (21980 : ℝ) / 50000 := by
  rw [delta_astar 28 0 (-7) (-2) (-21980) 17584 19500 21980 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar29 : delta astar 29 = (22765 : ℝ) / 50000 := by
  rw [delta_astar 29 0 (-7) (-2) (-22765) 5712 16625 22765 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar30 : delta astar 30 = (23550 : ℝ) / 50000 := by
  rw [delta_astar 30 0 (-7) (-2) (-23550) (-6160) 13750 23550 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar31 : delta astar 31 = (24335 : ℝ) / 50000 := by
  rw [delta_astar 31 0 (-7) (-2) (-24335) (-18032) 10875 24335 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar32 : delta astar 32 = (24880 : ℝ) / 50000 := by
  rw [delta_astar 32 (-1) (-8) (-2) 24880 20096 8000 24880 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar33 : delta astar 33 = (24095 : ℝ) / 50000 := by
  rw [delta_astar 33 (-1) (-8) (-2) 24095 8224 5125 24095 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar34 : delta astar 34 = (23310 : ℝ) / 50000 := by
  rw [delta_astar 34 (-1) (-8) (-2) 23310 (-3648) 2250 23310 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar35 : delta astar 35 = (22525 : ℝ) / 50000 := by
  rw [delta_astar 35 (-1) (-8) (-2) 22525 (-15520) (-625) 22525 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar36 : delta astar 36 = (22608 : ℝ) / 50000 := by
  rw [delta_astar 36 (-1) (-9) (-2) 21740 22608 (-3500) 22608 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar37 : delta astar 37 = (20955 : ℝ) / 50000 := by
  rw [delta_astar 37 (-1) (-9) (-2) 20955 10736 (-6375) 20955 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar38 : delta astar 38 = (20170 : ℝ) / 50000 := by
  rw [delta_astar 38 (-1) (-9) (-2) 20170 (-1136) (-9250) 20170 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar39 : delta astar 39 = (19385 : ℝ) / 50000 := by
  rw [delta_astar 39 (-1) (-9) (-2) 19385 (-13008) (-12125) 19385 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar40 : delta astar 40 = (24880 : ℝ) / 50000 := by
  rw [delta_astar 40 (-1) (-9) (-2) 18600 (-24880) (-15000) 24880 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar41 : delta astar 41 = (17875 : ℝ) / 50000 := by
  rw [delta_astar 41 (-1) (-10) (-2) 17815 13248 (-17875) 17875 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar42 : delta astar 42 = (20750 : ℝ) / 50000 := by
  rw [delta_astar 42 (-1) (-10) (-2) 17030 1376 (-20750) 20750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar43 : delta astar 43 = (23625 : ℝ) / 50000 := by
  rw [delta_astar 43 (-1) (-10) (-2) 16245 (-10496) (-23625) 23625 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar44 : delta astar 44 = (23500 : ℝ) / 50000 := by
  rw [delta_astar 44 (-1) (-10) (-3) 15460 (-22368) 23500 23500 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar45 : delta astar 45 = (20625 : ℝ) / 50000 := by
  rw [delta_astar 45 (-1) (-11) (-3) 14675 15760 20625 20625 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar46 : delta astar 46 = (17750 : ℝ) / 50000 := by
  rw [delta_astar 46 (-1) (-11) (-3) 13890 3888 17750 17750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar47 : delta astar 47 = (14875 : ℝ) / 50000 := by
  rw [delta_astar 47 (-1) (-11) (-3) 13105 (-7984) 14875 14875 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar48 : delta astar 48 = (19856 : ℝ) / 50000 := by
  rw [delta_astar 48 (-1) (-11) (-3) 12320 (-19856) 12000 19856 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar49 : delta astar 49 = (18272 : ℝ) / 50000 := by
  rw [delta_astar 49 (-1) (-12) (-3) 11535 18272 9125 18272 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar50 : delta astar 50 = (10750 : ℝ) / 50000 := by
  rw [delta_astar 50 (-1) (-12) (-3) 10750 6400 6250 10750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar51 : delta astar 51 = (9965 : ℝ) / 50000 := by
  rw [delta_astar 51 (-1) (-12) (-3) 9965 (-5472) 3375 9965 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar52 : delta astar 52 = (17344 : ℝ) / 50000 := by
  rw [delta_astar 52 (-1) (-12) (-3) 9180 (-17344) 500 17344 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar53 : delta astar 53 = (20784 : ℝ) / 50000 := by
  rw [delta_astar 53 (-1) (-13) (-3) 8395 20784 (-2375) 20784 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar54 : delta astar 54 = (8912 : ℝ) / 50000 := by
  rw [delta_astar 54 (-1) (-13) (-3) 7610 8912 (-5250) 8912 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar55 : delta astar 55 = (8125 : ℝ) / 50000 := by
  rw [delta_astar 55 (-1) (-13) (-3) 6825 (-2960) (-8125) 8125 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar56 : delta astar 56 = (14832 : ℝ) / 50000 := by
  rw [delta_astar 56 (-1) (-13) (-3) 6040 (-14832) (-11000) 14832 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar57 : delta astar 57 = (23296 : ℝ) / 50000 := by
  rw [delta_astar 57 (-1) (-14) (-3) 5255 23296 (-13875) 23296 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar58 : delta astar 58 = (16750 : ℝ) / 50000 := by
  rw [delta_astar 58 (-1) (-14) (-3) 4470 11424 (-16750) 16750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar59 : delta astar 59 = (19625 : ℝ) / 50000 := by
  rw [delta_astar 59 (-1) (-14) (-3) 3685 (-448) (-19625) 19625 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar60 : delta astar 60 = (22500 : ℝ) / 50000 := by
  rw [delta_astar 60 (-1) (-14) (-3) 2900 (-12320) (-22500) 22500 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar61 : delta astar 61 = (24625 : ℝ) / 50000 := by
  rw [delta_astar 61 (-1) (-14) (-4) 2115 (-24192) 24625 24625 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar62 : delta astar 62 = (21750 : ℝ) / 50000 := by
  rw [delta_astar 62 (-1) (-15) (-4) 1330 13936 21750 21750 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar63 : delta astar 63 = (18875 : ℝ) / 50000 := by
  rw [delta_astar 63 (-1) (-15) (-4) 545 2064 18875 18875 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar64 : delta astar 64 = (16000 : ℝ) / 50000 := by
  rw [delta_astar 64 (-1) (-15) (-4) (-240) (-9808) 16000 16000 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar65 : delta astar 65 = (21680 : ℝ) / 50000 := by
  rw [delta_astar 65 (-1) (-15) (-4) (-1025) (-21680) 13125 21680 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar66 : delta astar 66 = (16448 : ℝ) / 50000 := by
  rw [delta_astar 66 (-1) (-16) (-4) (-1810) 16448 10250 16448 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar67 : delta astar 67 = (7375 : ℝ) / 50000 := by
  rw [delta_astar 67 (-1) (-16) (-4) (-2595) 4576 7375 7375 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar68 : delta astar 68 = (7296 : ℝ) / 50000 := by
  rw [delta_astar 68 (-1) (-16) (-4) (-3380) (-7296) 4500 7296 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar69 : delta astar 69 = (19168 : ℝ) / 50000 := by
  rw [delta_astar 69 (-1) (-16) (-4) (-4165) (-19168) 1625 19168 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar70 : delta astar 70 = (18960 : ℝ) / 50000 := by
  rw [delta_astar 70 (-1) (-17) (-4) (-4950) 18960 (-1250) 18960 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar71 : delta astar 71 = (7088 : ℝ) / 50000 := by
  rw [delta_astar 71 (-1) (-17) (-4) (-5735) 7088 (-4125) 7088 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
theorem dstar72 : delta astar 72 = (7000 : ℝ) / 50000 := by
  rw [delta_astar 72 (-1) (-17) (-4) (-6520) (-4784) (-7000) 7000 (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)]; norm_num
...
theorem nine_le_card_image {N : ℕ} (f : ℕ → ℝ) {q₀ q₁ q₂ q₃ q₄ q₅ q₆ q₇ q₈ : ℕ}
  ...
  have e0 : f q₀ ∉ ({f q₁, f q₂, f q₃, f q₄, f q₅, f q₆, f q₇, f q₈} : Finset ℝ) := by
    ...
    exact ⟨ne_of_gt h01, ne_of_gt a0_2, ne_of_gt a0_3, ne_of_gt a0_4, ne_of_gt a0_5, ne_of_gt a0_6, ne_of_gt a0_7, ne_of_gt a0_8⟩
  have e1 : f q₁ ∉ ({f q₂, f q₃, f q₄, f q₅, f q₆, f q₇, f q₈} : Finset ℝ) := by
    simp only [Finset.mem_insert, Finset.mem_singleton, not_or]
    exact ⟨ne_of_gt h12, ne_of_gt a1_3, ne_of_gt a1_4, ne_of_gt a1_5, ne_of_gt a1_6, ne_of_gt a1_7, ne_of_gt a1_8⟩
  ...
  have hsub : ({f q₀, f q₁, f q₂, f q₃, f q₄, f q₅, f q₆, f q₇, f q₈} : Finset ℝ) ⊆ (Finset.range (N + 1)).image f := by
    intro x hx
    simp only [Finset.mem_insert, Finset.mem_singleton] at hx
    rcases hx with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl <;> exact Finset.mem_image_of_mem f ‹_›
  calc 9 = _ := hcard.symm
...
theorem card_ge_nine (α : Fin 3 → ℝ)
  ...
  have v24 : nnDist α 73 24 = (Finset.Icc 1 49).inf' ne49 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne49
  have v23 : nnDist α 73 23 = (Finset.Icc 1 50).inf' ne50 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne50
  have v22 : nnDist α 73 22 = (Finset.Icc 1 51).inf' ne51 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne51
  have v19 : nnDist α 73 19 = (Finset.Icc 1 54).inf' ne54 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne54
  have v18 : nnDist α 73 18 = (Finset.Icc 1 55).inf' ne55 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne55
  have v6 : nnDist α 73 6 = (Finset.Icc 1 67).inf' ne67 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne67
  have v5 : nnDist α 73 5 = (Finset.Icc 1 68).inf' ne68 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne68
  have v2 : nnDist α 73 2 = (Finset.Icc 1 71).inf' ne71 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne71
  have v1 : nnDist α 73 1 = (Finset.Icc 1 72).inf' ne72 (fun n => delta α n) := nnDist_eq_inf α (by norm_num) ne72
  refine nine_le_card_image (nnDist α 73)
    (q₀ := 24) (q₁ := 23) (q₂ := 22) (q₃ := 19) (q₄ := 18) (q₅ := 6) (q₆ := 5) (q₇ := 2) (q₈ := 1)
    (by decide) (by decide) (by decide) (by decide) (by decide) (by decide) (by decide) (by decide) (by decide) ?_ ?_ ?_ ?_ ?_ ?_ ?_ ?_
  · rw [v23, v24]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 50 (by decide) ne49 ne50 (fun n hn => ?_)
    show delta α (50 : ℤ) < delta α (n : ℤ); exact H1 n hn
  · rw [v22, v23]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 51 (by decide) ne50 ne51 (fun n hn => ?_)
    show delta α (51 : ℤ) < delta α (n : ℤ); exact H2 n hn
  · rw [v19, v22]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 54 (by decide) ne51 ne54 (fun n hn => ?_)
    show delta α (54 : ℤ) < delta α (n : ℤ); exact H3 n hn
  · rw [v18, v19]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 55 (by decide) ne54 ne55 (fun n hn => ?_)
    show delta α (55 : ℤ) < delta α (n : ℤ); exact H4 n hn
  · rw [v6, v18]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 67 (by decide) ne55 ne67 (fun n hn => ?_)
    show delta α (67 : ℤ) < delta α (n : ℤ); exact H5 n hn
  · rw [v5, v6]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 68 (by decide) ne67 ne68 (fun n hn => ?_)
    show delta α (68 : ℤ) < delta α (n : ℤ); exact H6 n hn
  · rw [v2, v5]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 71 (by decide) ne68 ne71 (fun n hn => ?_)
    show delta α (71 : ℤ) < delta α (n : ℤ); exact H7 n hn
  · rw [v1, v2]
    refine inf_lt_inf (fun n => delta α (n : ℤ)) 72 (by decide) ne71 ne72 (fun n hn => ?_)
    show delta α (72 : ℤ) < delta α (n : ℤ); exact H8 n hn
...
theorem norm_aprt (s : ℝ) (hs : 0 ≤ s) : ‖aprt s - astar‖ = s := by
  ...
  have e2 : (aprt s - astar) 2 = 0 := by
    simp only [Pi.sub_apply, aprt, astar, Matrix.cons_val_two, Matrix.head_cons, Matrix.tail_cons]; ring
...
this gives `g_∞(3) = 9` — the Shutov bound `2^d+1` is attained (Haynes–Ramirez, `d ≤ 3`). The witness
is `α = (−785/50000 + s, −11872/50000, −2875/50000)` for a small irrational `s`; `card ≥ 9` transports
